...
"""
AI Brain Support Router for Syntax Prime V2 - CLEANED VERSION
Handles non-chat AI endpoints: personalities, stats, feedback, conversations
Chat processing moved to chat.py to avoid duplication
Date: 9/26/25 - Removed duplicate /ai/chat endpoint
"""
...
#-- Section 4: Default User Helper - 9/23/25
DEFAULT_USER_ID = "b7c60682-4815-4d9d-8ebe-66c6cd24eff9"

#-- Section 5: Feedback Processing - 9/23/25
async def process_feedback(feedback_request: FeedbackRequest, user_id: str = None) -> FeedbackResponse:
    ...
    # Get the actual thread_id from the message instead of hardcoded string
    try:
...
#-- Section 6: API Endpoints - 9/23/25

# NOTE: /ai/chat endpoint REMOVED - handled by chat.py to avoid duplication
...
async def submit_feedback(feedback_request: FeedbackRequest):
    ...
    """
    return await process_feedback(feedback_request)
...
#-- Section 7: Conversation Management Endpoints - 9/23/25
...
#-- Section 8: Knowledge Search and Statistics Endpoints - 9/23/25
...
#-- Section 9: System Testing and Health Check Endpoints - 9/23/25
@router.post("/test")
...
#-- Section 10: Cleanup and Shutdown Handlers - 9/23/25
...
#-- Section 11: Module Information and Health Check Functions - 9/23/25
def get_integration_info():
    """Get information about the AI brain support integration"""
    return {
        "name": "AI Brain Support Router",
        "version": "2.0.0",
        "description": "Non-chat AI endpoints: personalities, stats, feedback, conversations",
        "note": "Main chat processing handled by chat.py module",
        "components": [
            "Personality Engine",
            "Feedback Processor",
...
def check_module_health():
    ...
    return {
        ...
        "chat_endpoint_status": "handled_by_chat_module",
        "default_user_id": DEFAULT_USER_ID,
        "note": "This module handles non-chat AI endpoints only"
    }
